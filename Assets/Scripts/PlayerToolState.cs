public enum ActiveTool { None, Plow, Seed, Tree, Animal, Fire, Decoration }
...
public class PlayerToolState
{
    ...
    public bool hasDecoration => activeTool == ActiveTool.Decoration;
    ...
    public void SetDecoration() { activeTool = ActiveTool.Decoration; }
